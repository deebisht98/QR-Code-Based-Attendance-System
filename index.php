		...
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<img src = "admin/images/logo.png" width = "200px" height = "60px"/>
					<p class = "navbar-text pull-right">QR-Code Based Attendance System</p>
				</div>
			</div>
		</nav>
		<div class = "container-fluid">
			...
			<div class = "col-lg-6 well">
				...
				<h3 style="text-align:center;"><a href="scanner.html">Login with QR-Code</a></h3>
			</div>
		</div>
	</body>
